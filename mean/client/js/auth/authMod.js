...
/**
 * checks to ensure callback f(x) is a real function
...
function AuthService($location, $http, $cookies, $q) {
  'ngInject';
  //Both current User and user are variables 
...
angular.module('authMod', ['ngCookies'])
